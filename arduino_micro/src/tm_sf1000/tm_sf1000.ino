...
// Define constants
#define AMOUNTOFBYTES 12
#define WHEELIDBITS 3
...
// SF1000
int firstByteID[WHEELIDBITS] = {1, 0, 0};
int buttonMap[WHEELBUTTONBITS] = {4, -1, -1, -1, 0, 1, 2, 3, 12, 5, 6, 7, 8, 9, 10, 11, 17, 33, 32, 34, 31, 18, 19, 20, -1, 15, 13, 14, 16, -1, -1, -1};
